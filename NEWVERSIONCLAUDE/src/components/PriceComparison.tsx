...
export const PriceComparison: React.FC<PriceComparisonProps> = ({ prices }) => {
  ...
  // Get the current marketplace price (which is already converted to EUR)
      ...
      <div className="price-list">
        {prices
          ...
          .map((price, index) => {
            ...
            const flagSrc = getFlagUrl(countryCode);
            ...
            return (
              ...
              >
                <div className="marketplace">
                  <img src={flagSrc} alt={countryCode} className="flag" />
                ...
                <div className="price-details">
                  ...
                  <span className="shipping-value" data-total={`${totalPrice.toFixed(2)} €`}>
                    {price.shipping === 0 ? 'Free' : `${price.shipping?.toFixed(2)} €`}
                  </span>
